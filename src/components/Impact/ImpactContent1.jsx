...
const stats = [
	{ label: 'Tons of CO2', value: '85,321' },
	{ label: 'Plastic Bottles', value: '14,650' },
	{ label: 'Lts. of Clean Water', value: '46,000' },
	{ label: 'Envolved Customers', value: '32,000+' },
];

export default function ImpactContent1() {
	return (
		<div className='bg-primary-900 py-24 sm:py-32'>
			...
			<div className='mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8'>
				<div className='lg:pr-4'>
					<div className='hover: relative overflow-hidden rounded-xl bg-primary-900 px-6 pb-9 pt-64 shadow-sm sm:px-12 lg:max-w-full lg:px-8 lg:pb-8 xl:px-10 xl:pb-10'>
						<img
							...
							alt=''
						/>
						<div className='absolute inset-0 bg-secondary-900 mix-blend-multiply' />
						<div
						...
						<figure className='relative isolate'>
							...
							<blockquote className='mt-6 text-xl font-semibold leading-8 text-white'>
								<p className='mb-4'>
									Some of the revenues go to the experts of the topic. The Ocean Cleanup is one of
