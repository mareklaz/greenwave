		...
		<div className='relative isolate bg-primary-50 pt-14'>
			<div className='mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40'>
				<div className='mx-auto max-w-2xl lg:mx-0 lg:flex-auto'>
					...
					<h1 className='max-w-lg text-4xl font-bold tracking-tight text-primary-900 sm:text-6xl'>
						Track your ocean efforts
					</h1>
					<p className='mt-6 text-lg leading-8 text-primary-600'>
						Make a difference for our oceans with the Green Wave app's individual section. Easily
						monitor your sustainable choices, from eco-friendly purchases to reducing plastic usage
						and beach clean-ups. Celebrate milestones, earn badges, and connect with a vibrant
						community.
					</p>
					<p className='my-2 text-lg leading-8 text-primary-600'>
						Join us and be a part of the collective force for positive change in ocean conservation.
					</p>
					<p className='my-2 text-lg leading-8 text-primary-600'>
